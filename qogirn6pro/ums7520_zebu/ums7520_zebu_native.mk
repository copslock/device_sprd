...
export KERNEL_PATH
$(call inherit-product, device/sprd/qogirn6pro/ums7520_zebu/ums7520_zebu_base.mk)
PLATDIR := device/sprd/qogirn6pro
TARGET_BOARD := ums7520_zebu
...
TARGET_BOOTLOADER_BOARD_NAME := ums7520_zebu
CHIPRAM_DEFCONFIG := ums7520_zebu
UBOOT_DEFCONFIG := ums7520_zebu
UBOOT_TARGET_DTB := ums7520_zebu

PRODUCT_NAME := ums7520_zebu_native
PRODUCT_DEVICE := ums7520_zebu
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ums7520_zebu_native
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ums7520_zebu.xml:$(PRODUCT_OUT)/ums7520_zebu.xml
