...
# after setting these options, include this file as include "device/sprd/qogirn6pro/common/security_feature.mk"
#
...
TARGET_SML_CONFIG := qogirn6pro@qogirn6pro
...
ifneq ($(BOARD_FEATUREPHONE_CONFIG),)
CFG_TRUSTY_DEFAULT_PROJECT := qogirn6pro-feature
else
CFG_TRUSTY_DEFAULT_PROJECT ?= qogirn6pro
endif
...
include vendor/sprd/partner/microarray/qogirn6pro/microarray_qogirn6pro.mk
endif
