...
LOCAL_PATH := device/sprd/qogirn6pro/common
...
POWERHINT_PRODUCT_CONFIG := qogirn6pro
...
PRODUCT_COPY_FILES += \
	...
	vendor/sprd/modules/libcamera/kernel_module/init.sprd_vdsp.rc:vendor/etc/init/init.sprd_vdsp.rc
...
#PRODUCT_COPY_FILES += \
    vendor/sprd/external/drivers/gpu/rogue/driver/build/linux/qogirn6pro_android/pvrsrvkm.ko:vendor/lib/modules/pvrsrvkm.ko
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/power/ddr/bm/tool/qogirn6pro_cm4_disable_smart_light.bin:/vendor/bin/power/ddr/bm/tool/qogirn6pro_cm4_disable_smart_light.bin
PRODUCT_COPY_FILES += \
