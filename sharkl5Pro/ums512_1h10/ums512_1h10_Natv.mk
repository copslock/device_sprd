...
export KERNEL_PATH
$(call inherit-product, device/sprd/sharkl5Pro/ums512_1h10/ums512_1h10_Base.mk)
PLATDIR := device/sprd/sharkl5Pro
TARGET_BOARD := ums512_1h10
...
CHIPRAM_DEFCONFIG := ums512_1h10
UBOOT_DEFCONFIG := ums512_1h10
UBOOT_TARGET_DTB := ums512_1h10

PRODUCT_NAME := ums512_1h10_Natv
...
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.multi.section=3

PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ums512_1h10.xml:$(PRODUCT_OUT)/ums512_1h10.xml
