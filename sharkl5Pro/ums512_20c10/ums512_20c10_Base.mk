...
BOARD_HAVE_SPRD_WCN_COMBO := marlin3_lite
...
PRODUCT_COPY_FILES += \
    ...
    $(PLATCOMM)/rootdir/system/usr/idc/focaltech_spi_ts.idc::$(TARGET_COPY_OUT_VENDOR)/usr/idc/focaltech_spi_ts.idc
...
#decrypt config
PRODUCT_COPY_FILES += \
    vendor/sprd/modules/libcamera/arithmetic/interface/lib/libinterface.so:$(TARGET_COPY_OUT_VENDOR)/lib/libinterface.so \
    vendor/sprd/modules/libcamera/arithmetic/verify/lib/libverify.so:$(TARGET_COPY_OUT_VENDOR)/lib/libverify.so \
    vendor/sprd/modules/libcamera/arithmetic/info/lib/libinfo.so:$(TARGET_COPY_OUT_VENDOR)/lib/libinfo.so
