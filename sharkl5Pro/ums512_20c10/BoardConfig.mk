...
include device/sprd/sharkl5Pro/common/BoardCommon.mk
...
BACK_EXT_CAMERA_SUPPORT_SIZE := 2M
FRONT_EXT_CAMERA_SUPPORT_SIZE := 8M
BACK_EXT2_CAMERA_SUPPORT_SIZE := 2M
...
CAMERA_SENSOR_TYPE_BACK := "s5k3l6"
CAMERA_SENSOR_TYPE_FRONT := "hi846"
CAMERA_SENSOR_TYPE_BACK_EXT := "ov2680"
CAMERA_SENSOR_TYPE_FRONT_EXT := "hi846_wide"
CAMERA_SENSOR_TYPE_BACK_EXT2 := "gc2375h"

#camera dual sensor
TARGET_BOARD_CAMERA_DUAL_SENSOR_MODULE := true

#tuning param support list
TUNING_PARAM_LIST := "s5k3l6,hi846,ov2680,hi846_wide,gc2375h"
...
#flash IC
TARGET_BOARD_CAMERA_FLASH_TYPE := sy7807
...
TARGET_BOARD_BACK_HIGH_RESOLUTION_SUPPORT := false
...
BOARD_SEPOLICY_DIRS += device/sprd/sharkl5Pro/common/sepolicy #\
    #device/generic/goldfish/sepolicy/common
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += device/sprd/sharkl5Pro/common/plat_sepolicy/private
BOARD_PLAT_PUBLIC_SEPOLICY_DIR += device/sprd/sharkl5Pro/common/plat_sepolicy/public
...
SENSOR_HUB_ACCELEROMETER := kxtj3
SENSOR_HUB_GYROSCOPE := null
SENSOR_HUB_LIGHT := stk3338v
SENSOR_HUB_MAGNETIC := null
SENSOR_HUB_PROXIMITY := stk3338v
SENSOR_HUB_PRESSURE := null
SENSOR_HUB_CALIBRATION := ums512
