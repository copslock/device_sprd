...
export KERNEL_PATH
$(call inherit-product, device/sprd/sharkl3/s9863a2h10/s9863a2h10_Base.mk)
PLATDIR := device/sprd/sharkl3
TARGET_BOARD := s9863a2h10
...
TARGET_BOOTLOADER_BOARD_NAME := sp9863a_2h10
CHIPRAM_DEFCONFIG := sp9863a_2h10
UBOOT_DEFCONFIG := sp9863a_2h10
UBOOT_TARGET_DTB := sp9863a_2h10

PRODUCT_NAME := s9863a2h10_Natv
PRODUCT_DEVICE := s9863a2h10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := s9863a2h10_Natv
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/s9863a2h10.xml:$(PRODUCT_OUT)/s9863a2h10.xml
