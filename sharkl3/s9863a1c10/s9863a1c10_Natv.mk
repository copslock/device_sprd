...
export KERNEL_PATH
$(call inherit-product, device/sprd/sharkl3/s9863a1c10/s9863a1c10_Base.mk)
PLATDIR := device/sprd/sharkl3
TARGET_BOARD := s9863a1c10
...
TARGET_BOOTLOADER_BOARD_NAME := sp9863a_1c10
CHIPRAM_DEFCONFIG := sp9863a_1c10
UBOOT_DEFCONFIG := sp9863a_1c10
UBOOT_TARGET_DTB := sp9863a_1c10

PRODUCT_NAME := s9863a1c10_Natv
PRODUCT_DEVICE := s9863a1c10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := s9863a1c10_Natv
...
#camera infrared
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.infrared.enable=0
...
#multi camera
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.res.multi.camera=RES_MULTI

#mutli camera section
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.multi.section=2

PRODUCT_COPY_FILES += \
    $(BOARDDIR)/s9863a1c10.xml:$(PRODUCT_OUT)/s9863a1c10.xml
...
PRODUCT_SOCKO_KO_LIST := \
    $(BSP_KERNEL_MODULES_OUT)/flash_ic_aw3641.ko \
