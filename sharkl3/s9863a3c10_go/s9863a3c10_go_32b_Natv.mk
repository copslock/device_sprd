...
export KERNEL_PATH
BOARD_PATH=$(KERNEL_PATH)/sprd-board-config/sharkl3/sp9863a_3c10_go/sp9863a_3c10_go_32b_native
include $(BOARD_PATH)
PRODUCT_GO_DEVICE := true
$(call inherit-product, device/sprd/sharkl3/s9863a3c10_go/s9863a3c10_go_Base.mk)
PLATDIR := device/sprd/sharkl3
TARGET_BOARD := s9863a3c10_go
...
CHIPRAM_DEFCONFIG := sp9863a_3c10_32b
UBOOT_DEFCONFIG := sp9863a_3c10_32b
UBOOT_TARGET_DTB := sp9863a_3c10_32b



PRODUCT_NAME := s9863a3c10_go_32b_Natv
PRODUCT_DEVICE := s9863a3c10_go
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := s9863a3c10_go_32b_Natv
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/s9863a3c10_go.xml:$(PRODUCT_OUT)/s9863a3c10_go.xml
