...
PRODUCT_COPY_FILES += \
    bsp/modules/gpu/midgard/mali/platform/pike2/libboost.so:$(TARGET_COPY_OUT_VENDOR)/lib/libboost.so
endif
endif
...
ifeq ($(TARGET_BUILD_VARIANT),user)
PRODUCT_PROPERTY_OVERRIDES += \
    persist.sys.cam.wide.frame.gap=4
else
PRODUCT_PROPERTY_OVERRIDES += \
    persist.sys.cam.wide.frame.gap=3
endif
